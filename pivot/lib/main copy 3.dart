          ...
          ElevatedButton(
            onPressed: () async {
              ...
              List<String> arguments = [
                ...
                "profit",
              ]; // Ensure these match your script's expected input
              print(columnFields.toString());
              print(rowFields.toString());
              try {
                // Run the executable
                ProcessResult result = await Process.run(
                    "data/flutter_assets/assets/dist/script.exe", arguments);
                ...
                if (result.exitCode == 0) {
                  ...
                  print('Executable Result: ${result.stdout}');
                } else {
            ...
            child: Text('Run Python Executable'),
          ),
        ],
      ),
    );
